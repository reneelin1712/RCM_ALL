...
def interpret_model():
    ...
    # Check the type and shape of policy_shap_values
    print('Type of policy_shap_values:', type(policy_shap_values))
    if isinstance(policy_shap_values, list):
        print('policy_shap_values is a list of length:', len(policy_shap_values))
        print('Shape of policy_shap_values[0]:', policy_shap_values[0].shape)
    else:
        print('Shape of policy_shap_values:', policy_shap_values.shape)
