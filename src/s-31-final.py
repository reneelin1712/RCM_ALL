...
def interpret_model():
    ...
    # Select test samples
    policy_test_samples = input_array_flat[:30]  # Adjust as needed
    ...
    # state_list = state_list[:num_samples]
    ...
    shap.summary_plot(policy_shap_values_per_feature, policy_test_samples_per_feature, feature_names=feature_names_channels)
    ...
    df_global_shap_sorted.to_csv('global_feature_importance.csv', index=False)
